...
var galleryGroups:Array<String> = [
    "mods/dustin/images/gallery/梗图",
    "mods/dustin/images/gallery/概念图",
    "mods/dustin/images/gallery/过场动画",
    "mods/dustin/images/gallery/竞赛获胜作品",
    "mods/dustin/images/gallery/抽象的",
    "mods/dustin/images/gallery/懒人汉化组"
];
...
function create() {
    ...
    previewText.setFormat(Paths.font("DTM-Mono.ttf"), 16, 0xFFFFFFFF, "center");
    ...
    groupLabel.setFormat(Paths.font("DTM-Mono.ttf"), 18, 0xFFFFFF, "center");
    ...
    leftArrow.setFormat(Paths.font("DTM-Mono.ttf"), 40, FlxColor.WHITE, FlxTextAlign.CENTER);
    ...
    rightArrow.setFormat(Paths.font("DTM-Mono.ttf"), 40, FlxColor.WHITE, FlxTextAlign.CENTER);
