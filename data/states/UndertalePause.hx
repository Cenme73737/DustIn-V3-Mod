...
function create(_) {
	...
	statTextObj = newFunkinTypeText(bottom.x + Math.floor(FlxG.width * 0.0395), bottom.y + Math.floor(FlxG.height * 0.043), bottom.extra["bWidth"] - bottom.extra["border"] - 15, statsDescription != null ? statsDescription : "* 加斯特 ？？ 攻击，？？ 防御\n* 黑暗，愈发深沉。\n* 你本不该看到这些。");
